...
const logger = require('./src/javascript/checkoutPage/logger');
// schema validates incoming requests
const {
  validatePaymentPayload,
  validateCreateCardPayload,
} = require('./src/javascript/checkoutPage/schema');
// square provides the API client and error types
const { ApiError, client: square } = require('./src/javascript/checkoutPage/square');
